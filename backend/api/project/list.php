<?php
    ...
    try {
        $query = "SELECT E.idUtilisateur utilisateur, P.idProjet projet, nom, hauteurToile, largeurToile, dateCreation, dateModif FROM ".$ini["PROJET"]["Table_Project"]." P JOIN Editer E ON P.idProjet = E.idProjet WHERE idUtilisateur = ".$_SESSION["id"].";";
